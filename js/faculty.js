...
export const DEPARTMENT_FIELDS = {
  ...
  iletisim:            ['Gazetecilik', 'Halkla İlişkiler', 'Reklam', 'Radyo-TV', 'Yeni Medya', 'İletişim Tasarımı', 'Medya Çalışmaları'],
  siyaset_bilimi:      ['Siyaset Teorisi', 'Siyasi Düşünce', 'Karşılaştırmalı Siyaset', 'Türk Siyasal Hayatı', 'Uluslararası İlişkiler', 'Kamu Yönetimi', 'Siyaset Sosyolojisi'],
